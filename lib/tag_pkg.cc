...
int tagClass::loadW (
  ...
  tagName[numTags] = tag;
  tagDestination[numTags] = (void *) source;
  tagDestType[numTags] = tagClass::INTEGER;
  tagDefault[numTags] = (void *) NULL;
...
int tagClass::loadW (
  ...
  tagDestination[numTags] = (void *) source;
  tagDestType[numTags] = tagClass::INTEGER;
  tagDefault[numTags] = (void *) oneDefault;
...
int tagClass::loadBoolW (
  ...
  tagName[numTags] = tag;
  tagDestination[numTags] = (void *) source;
  tagDestType[numTags] = tagClass::BOOLEAN;
  tagDefault[numTags] = (void *) NULL;
...
int tagClass::loadW ( // enumerated, translate integer source into string value
  char *tag,
  int numValues,
  char **strValues,
  int *intValues,
...
int tagClass::loadW ( // enumerated array, translate integer source
  ...
  tagName[numTags] = tag;
  tagDestMaxSize[numTags] = numElements;
  tagDestination[numTags] = (void *) source;
  tagDestType[numTags] = tagClass::ENUMERATED_ARRAY;
  enumNumChoices[numTags] = numValues;
  enumStrArray[numTags] = strValues;
...
int tagClass::loadW ( // no default variation, default is NULL
  char *tag,
  efDouble *destination
) {
...
int tagClass::loadComplexW (
  ...
  tagName[numTags] = tag;
  tagDestination[numTags] = (void *) source;
  tagDestType[numTags] = tagClass::COMPLEX_STRING;
  tagDefault[numTags] = (void *) NULL;
...
int tagClass::loadComplexW (
  ...
  tagName[numTags] = tag;
  tagDestination[numTags] = (void *) source;
  tagDestType[numTags] = tagClass::COMPLEX_EXP_STRING;
  tagDefault[numTags] = (void *) NULL;
...
int tagClass::loadHexW (
  ...
  tagDestination[numTags] = (void *) source;
  tagDestMaxSize[numTags] = numElements;
  tagDestType[numTags] = tagClass::HEX_INTEGER_ARRAY;
  tagDefault[numTags] = (void *) NULL;
  ...
  for ( index=0; index<numTags; index++ ) {
    ...
    case tagClass::STRING_ARRAY: // string 2d fixed size array
      ...
      if ( s ) {
        ...
        fprintf( stderr, tagClass_str23, tagName[index] );        return 0;
