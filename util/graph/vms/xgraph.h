...
* global values
*/
globalvalue XGRAPH_SUCCESS;
globalvalue XGRAPH_NO_DISPLAY;
globalvalue XGRAPH_NO_MEM;
globalvalue XGRAPH_NO_COLOR;
globalvalue XGRAPH_NO_FONT;
globalvalue XGRAPH_BAD_OBJ;
globalvalue XGRAPH_SCALE_MISMATCH;
globalvalue XGRAPH_BAD_LOG_VALUE;
