...
char title[32], *ptr;
  ...
  ef.addColorButtonWithRule( activeRectangleClass_str14, actWin->ci, &lineCb, &bufLineColor, 27, NULL );
  ef.addToggle( activeRectangleClass_str15, &bufLineColorMode );
  ef.addToggle( activeRectangleClass_str16, &bufFill );
  ef.addColorButtonWithRule( activeRectangleClass_str17, actWin->ci, &fillCb, &bufFillColor, 27, NULL );
