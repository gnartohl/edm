...
//  20060717 Rolf Keitel: re-package as "Triumf Slider"
//    Note: I'll keep the ifdef TRIUMF in order to indicate the changes from the
//          Motif Slider

#ifndef __triumfSlider_h
#define __triumfSlider_h 1
...
#ifdef __triumfSlider_cc

#include "triumfSlider.str"
...
class activeTriumfSliderClass : public activeGraphicClass {
...
static char *rangeString;
static double rangeArray[7];
#endif
...
activeTriumfSliderClass ( void );

activeTriumfSliderClass
...
void *clone_activeTriumfSliderClassPtr ( void * );
